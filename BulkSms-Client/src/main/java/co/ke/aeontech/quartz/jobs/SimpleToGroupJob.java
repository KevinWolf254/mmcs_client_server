...
/**
 * Sends scheduled sms's to a group of contacts for an organization
 * 
 * @author _Kanyi
 * @version 1.0
 */
public class SimpleToGroupJob extends QuartzJobBean implements InterruptableJob {
	...
	private static final Logger log = LoggerFactory.getLogger(SimpleToGroupJob.class);
